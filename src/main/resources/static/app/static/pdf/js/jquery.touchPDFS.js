		...
		function initDom() {
			...
			if (options.showToolbar) {
				...
				$element.find(".pdf-toolbar").html(
					'<div class="pdf-button"><button class="pdf-prev" style="background-color:#ccc;border:none;border-radius:5px;">上一页</button></div>'
				 	+ '<div class="pdf-button"><span class="pdf-page-count"></span></div>'
				 	+ '<div class="pdf-button"><button class="pdf-next" style="background-color:#ccc;border:none;border-radius:5px;">下一页</button></div>'
		...
		*/
		...
		function updatePageCount() {
			...
			if(pageNum==totalPages){
				$element.find(".pdf-page-count").html('<a href="javascript:void (0)"   onclick="doClose()" style="color:red;">我已阅读简章【关闭】</a>');
			}
		}
